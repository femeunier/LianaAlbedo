...
directory <- "/home/carya/R/edr-da/outputs"

files <- file.path(directory, c("Foster_edr_LAI.rds", "Marvin_edr_LAI.rds"))
refs <- c("Foster", "Marvin")
...
ggplot(data = posterior_sample_all,
