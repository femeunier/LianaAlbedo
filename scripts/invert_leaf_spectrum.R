...
# Those are data
files <- c("Figure6_sanchez2009_PNM_all.rds",
           "Figure6_sanchez2009_FTS_all.rds",
           "Figure1_Guzman.rds",
           "Figure1_kalacska.rds",
           "Figures4and5_castro_PNM.rds",
           "Figures4and5_castro_FTS.rds")
Names <- c("Sanchez_PNM",
           "Sanchez_FTS",
           "Guzman",
           "Kalacska",
...
save.image(file = "~/data/RTM/Inverse_leaf_spectrum_Sanchez2.Rdata")