...
Kalacska_post <- readRDS(file = "~/data/RTM/current_samples_Kalacska_steps_all.rds")
...
references <- c("Kalacska","Marvin","Sanchez","Foster")
...
save.image(file = "~/data/RTM/all_distributions.RData")