...
vars <- c("PAR_liana",'nir_liana','nir','ir','ir_liana','ir_tree','Spectrum','Vis','Red',"PAR","PAR_tree","nir_tree","sir_liana","sir_tree")
...
refs <-c("Sanchez","Marvin","Kalacska","Foster")

history_files <- c("/home/carya/output/PEcAn_99000000002/out/PDA_EDRTM/Gigante_history-S-2004-01-01-120000-g01.h5",
                   "/home/carya/output/PEcAn_99000000002/out/PDA_EDRTM/Gigante_history-S-2004-01-01-120000-g01.h5",
                   "/home/carya/output/PEcAn_99000000002/out/PDA_EDRTM/Gigante_history-S-2004-01-01-120000-g01.h5",
                   "/home/carya/data/RTM/Foster_history-S-2004-01-01-120000-g01.h5")
...
for (iref in seq(1,length(best_sets))){
  ...
  # Copyfiles
  system2("cp",c(history_files[iref],h5file))
  ...
  system2("cp",c(history_files[iref],file.path(OP_dir,basename(h5file))))
  ...
  for (iquantile in seq(quantiles)){
    ...
    for (iparam in seq(1,Nparams)){
      ...
      OP <- run_ED_RTM(rundir,outdir=modeloutdir,params=temp_params,crown_mod,inventory,par.wl,nir.wl,
                       temp = FALSE,outputdir = OP_dir)
...
save.image(file = "~/data/RTM/Inverse_canopy_spectrum_CM0.Rdata")
